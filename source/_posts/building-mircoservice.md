...
我见过大部分的系统使用的是zookeeper，因为他是java写的，可以非常好的跟java技术栈相结合。但是我个人觉得单纯从服务发现功能来看，consul更牛逼一些，他提供restful接口，这意味着对其他技术栈也是非常友好的，同时他提供了一个现成的DNS服务器，这意味着使用DNS做服务发现的系统可以无缝直接迁移到consul上，不需要修改代码。
